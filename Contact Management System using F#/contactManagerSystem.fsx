#r "C:\Program Files\dotnet\shared\Microsoft.WindowsDesktop.App\8.0.10\System.Windows.Forms.dll"
...
let btnAdd = new Button(Text = "Add Contact", Top = 140, Left = 20)
let btnSearchByName = new Button(Text = "Search by Name", Top = 140, Left = 120, Width = 100)
let btnSearchByPhone = new Button(Text = "Search by Phone", Top = 140, Left = 260)
let btnUpdate = new Button(Text = "Update Contact", Top = 140, Left = 400)
let btnDelete = new Button(Text = "Delete Contact", Top = 140, Left = 520)
let btnDisplayAll = new Button(Text = "Display All Contacts", Top = 140, Left = 640)
...
let displayAllContacts () =
    let allContacts = contacts.Values |> List.ofSeq
